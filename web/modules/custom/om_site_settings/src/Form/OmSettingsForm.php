	...
	public function validateForm(array &$form, FormStateInterface $form_state)
	{
		...
		if ($archive_length > 100 || $archive_length < 1) {
			$form_state->setErrorByName(
				"archive_length",
				$this->t("The Archive Length Should be between 1 and 100")
			);
		};
		if (
			substr($website_code, 0, 3) !== "OM-" ||
			...
			$form_state->setErrorByName(
				"website_code",
				$this->t(
					"Website Code should start with 'OM-' and end with any 5 numbers, etc. 'OM-12345'"
				)
			);
		}
	}
